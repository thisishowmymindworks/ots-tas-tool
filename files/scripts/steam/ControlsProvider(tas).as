package controls
{
  ...
  public class ControlsProvider implements IControlsProvider
  {
    ...
    private var tas_skip_start_frame:Number;
    ...
    public function ControlsProvider()
    {
      ...
      this.tas_skip_start_frame = tas_json["skip_frame"];
      super();
    }
    ...
    public function isButtonPressed(param1:int, param2:Boolean = false) : Boolean
    {
      ...
      if(Number(UserData.getPlaytimeString()) < this.tas_max_frame && param1 == ButtonCode.ACCEPT.code && Number(UserData.getPlaytimeString()) >= this.tas_skip_start_frame) {
        return true;
      }
